...
function SignIn() {
  ...
  return (
    <div className='w-full min-h-screen bg-radial-glow flex justify-center items-center p-4 overflow-x-hidden overflow-y-auto relative'>
      ...
      <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-blue-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-float"></div>
      <div className="absolute bottom-1/4 right-1/4 w-[350px] h-[350px] bg-purple-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      >
        <div className="text-center mb-4">
          ...
          <p className='text-gray-400 text-sm'>
            Sign in to your <span className='text-blue-400 font-medium'>Virtual Assistant</span>
          </p>
        </div>
